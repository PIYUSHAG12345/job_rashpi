...
const Experience = () => {
    ...
    useEffect(() => {
        axios.get('https://job-rashpi-4.onrender.com/user/experiences')
            .then(response => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://job-rashpi-4.onrender.com/user/experiences', newExperience);
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`https://job-rashpi-4.onrender.com/user/experiences/${id}`);
